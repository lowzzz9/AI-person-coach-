// pose.js - Body Tracking Engine
// FILE TYPE: JavaScript Module
// Uses browser pose detection for real-time form tracking.
...
class PoseTracker {
  ...
  async load() {
    ...
    console.log('[PoseTracker] Body tracker loaded.');
    return this;
  }
  ...
  _draw(pose) {
    ...
    CONNECTIONS.forEach(([a, b]) => {
      ...
      if (p1 && p2 && p1.score > 0.25 && p2.score > 0.25) {
        // Gradient line — neon green
        const grad = ctx.createLinearGradient(p1.x, p1.y, p2.x, p2.y);
        grad.addColorStop(0, 'rgba(215,255,0,0.95)');
        grad.addColorStop(1, 'rgba(215,255,0,0.70)');
